                ...
                var cdialog = new sap.m.Dialog({
                    ...
                    endButton: new sap.m.Button({
                        ...
                        press: function (oEvent) {
                            ...
                            sap.ui.getCore().byId("entitytest::MasterDataObjectPage--fe::CustomSubSection::Attachments").mAggregations.items[1].destroyIncompleteItems(); cdialog.destroyContent();
                            ...
                            if (foldername === "Click on the folder to select path") {
                                ...
                                var _createEntity = function (item) {
                                    ...
                                    var settings = {
                                        ...
                                        url: "/odata/v4/catalog" + bPath + "/toFiles",
                                        method: "POST",
                                        headers: {
                                ...
                                _createEntity(item)
                                    .then((id) => {
                                        debugger
                                        // var url = baseuri + `odata/v4/catalog/Files(${id})/content`;
                                        var url = `/odata/v4/catalog/Files(ID=${id},IsActiveEntity=false)/content`;
                                        item.setUploadUrl(url);
                                        cdialog.close();
                                        cdialog.destroyContent();
                                        dialogOpen = false;
                                        // var oUploadSet = this.byId("uploadSet");
                                        var oUploadSet = sap.ui.getCore().byId("entitytest::MasterDataObjectPage--fe::CustomSubSection::Attachments--uploadSet") //.mAggregations.items[1];
